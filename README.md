...
![BiteExpress Demo](https://example.com/homepage.jpg) *(Replace with your homepage image URL)*  
...
### 1. Home Page  
![Home Page](./readme_img/project-8.png)  
- Featured restaurants, promotions, and search functionality.  

### 2. Food Items Page  
![Food Items](./readme_img/project-8-1.png)  
- List of dishes with filters (veg/non-veg, price range).  

### 3. Order Page  
![Order Page](./readme_img/project-8-cart.png)  
- Cart summary and order customization.  

### 4. Checkout Page  
![Checkout Page](https://example.com/checkout.jpg)  
